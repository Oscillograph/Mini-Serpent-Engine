...
//		std::vector<Decoration*> CollectionManager::PresetDecorationCollection = {};
		void CollectionManager::Init()
		{
//			PresetUnitCollection.resize(100, nullptr);
		}
		
		void CollectionManager::Add(Unit* unit)
		{
			PresetUnitCollection.push_back(unit);
		}
		
		void CollectionManager::Remove(Unit* unit)
		{
			auto it = std::find(PresetUnitCollection.begin(), PresetUnitCollection.end(), unit);
			if (it != PresetUnitCollection.end())
			{
